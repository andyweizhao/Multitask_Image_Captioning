...
if __name__ == "__main__":
  path = '/nlp/andyweizhao/self-critical.pytorch_CN/'
  parser = argparse.ArgumentParser()
  
  parser.add_argument('--input_json', default=path + 'data/dataset/dataset_combined.json', help='input json file to process into hdf5')
  parser.add_argument('--dict_json', default=path + 'data/meta/combined_meta.json', help='output json file')
  parser.add_argument('--output_pkl', default=path + 'data/combined-train', help='output pickle file')
