...
if __name__ == "__main__":
  ...
  # input json
  parser.add_argument('--input_json', default='data/dataset_coco_ccg.json', help='input json file to process into hdf5')
  parser.add_argument('--output_dir', default='data/cocotalk', help='output h5 file')

  # options
  parser.add_argument('--images_root', default='../dataset/MSCOCO', help='root location in which images are stored, to be prepended to file_path in input json')
  #parser.add_argument('--input_json', default='data/dataset_coco.json', help='input json file to process into hdf5')
  #parser.add_argument('--output_dir', default='data/cocotalk', help='output h5 file')

  # options
  #parser.add_argument('--images_root', default='/nlp/dataset/MSCOCO', help='root location in which images are stored, to be prepended to file_path in input json')
