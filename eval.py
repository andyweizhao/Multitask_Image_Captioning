...
opt.dump_images = 0
opt.num_images = -1
opt.cnn_model_path = 'save/multitask_pretrain_rl/best/model-cnn-best.pth'
opt.model_path = 'save/multitask_pretrain_rl/best/model-best.pth'
opt.infos_path = 'save/multitask_pretrain_rl/infos_topdown-best.pkl'
opt.start_from = 'save/multitask_pretrain_rl'
opt.split = 'test'
opt.language_eval = 1
#opt.batch_size=10
opt.beam_size = 20
...
#opt.image_folder='/nlp/dataset/MSCOCO/test2014'
#opt.num_images=-1
#opt.coco_json='image_info_test2014.json'
# Load infos
...
#    vars(opt))
loss, split_predictions, lang_stats = eval_utils.eval_split(cnn_model, model, crit, loader, vars(opt), True)
